...
import app.cn.extra.mall.merchant.bean.SafetyQuestionBean;
...
import app.cn.extra.mall.merchant.vo.MsGetSafetyQuestionOfUser;
                        ...
                        public void onResponse(String response, int id) {
                            ...
                            if (Constants.OK.equals(data.getFlag())) {
                                if (Constants.OK.equals(data.getData().getStatus())) {
                                    showShortToast(SafetyQuestionAuthActivity.this, getResources().getString(
                                            R.string.authSuccess));
                                     ...
                                     * 云信登录
                                     */
                                    IMLogin imLogin = new IMLogin(SafetyQuestionAuthActivity.this);
                                    imLogin.login(0);
                                } else {
                                    showShortToast(SafetyQuestionAuthActivity.this,
