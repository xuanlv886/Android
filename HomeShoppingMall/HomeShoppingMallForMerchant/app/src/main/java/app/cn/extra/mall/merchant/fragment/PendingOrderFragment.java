...
import app.cn.extra.mall.merchant.activity.PendingOrderDetailsActivity;
...
public class PendingOrderFragment extends BaseFragment
    ...
    private CommonAdapter<GetUserRequirement.DataBean.RequirementOrderListBean> adapter;
    /**
     * 当前页，用于分页获取数据 从1开始
     */
     ...
     * 用于存放临时数据
     */
    List<GetUserRequirement.DataBean.RequirementOrderListBean> userRequirementBeanList = null;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        mView = inflater.inflate(R.layout.fragment_pending_order, container, false);
    ...
    public void PendingOrderFragmentEventBus(PendingOrderFragmentEvent event) {
        getUserRequirement();
    }
...
//                DividerItemDecoration.VERTICAL));
    ...
    private void getUserRequirement() {
        if (Utils.isNetworkAvailable(MyDemandActivity.context)) {
            ...
            OkHttpUtils
                    ...
                    .addParams("roStatus", Constants.STATUS_DEMAND_PENDINGORDER)
    ...
    private void setRecommendProductData() {
        adapter = new CommonAdapter<GetUserRequirement.DataBean.RequirementOrderListBean>(
                MyDemandActivity.context, R.layout.list_item_demand, userRequirementBeanList) {
            @Override
            protected void convert(ViewHolder holder, GetUserRequirement.DataBean.RequirementOrderListBean userRequirementBean, int position) {
                ...
                holder.setText(R.id.tv_demand_type, "待接单");
                ...
                if ("取货送货".equals(userRequirementBean.getRtName())) {
                    ...
                    holder.setText(R.id.tv_demand_get_address, "取货送货:" + userRequirementBean.getUrGetAddress());
                } else {
...
//                }
        ...
        adapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                Intent intent = new Intent(MyDemandActivity.context, PendingOrderDetailsActivity.class);
