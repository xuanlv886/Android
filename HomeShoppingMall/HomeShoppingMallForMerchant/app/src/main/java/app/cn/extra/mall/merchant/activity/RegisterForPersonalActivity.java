 ...
 * @author lzy
 */
public class RegisterForPersonalActivity extends TakePhotoActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_for_personal);
    ...
    private void initView() {
        sharePreferenceUtil = new SharePreferenceUtil(RegisterForPersonalActivity.this,
                Constants.SAVE_USER);
    ...
    @OnClick({R.id.tv_submit, R.id.img_back, R.id.btn_captcha, R.id.rl_city, R.id.rl_sex,
            R.id.rl_id_img})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_captcha:
                ...
                break;
            case R.id.rl_city:
                startActivity(new Intent(RegisterForPersonalActivity.this,
    ...
    private void doSubmit() {
        ...
        if (!Utils.isValidPhoneNumber(etTel.getText().toString().trim())) {
            CustomToast.showToast(RegisterForPersonalActivity.this,
     ...
     * 个人身份商户注册接口
     */
    private void storePersonRegisteredPort() {
        if (Utils.isNetworkAvailable(RegisterForPersonalActivity.this)) {
            ...
            OkHttpUtils
                    .post()
                    .url(Constants.storePersonRegistered)
    ...
    private void gotoLoginActivity() {
        ...
        intent.setClass(RegisterForPersonalActivity.this, LoginActivity.class);
    ...
    public void takeSuccess(TResult result) {
        ...
        Glide.with(RegisterForPersonalActivity.this)
                .load(imgIdCardPath)
                .into(imgIdCard);
    }
