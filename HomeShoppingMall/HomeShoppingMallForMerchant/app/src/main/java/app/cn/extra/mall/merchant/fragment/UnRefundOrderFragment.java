...
import app.cn.extra.mall.merchant.event.UnRefundOrderEvent;
...
public class UnRefundOrderFragment extends BaseFragment implements SwipyRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_unrefund, container, false);
    ...
    private void getProductOrder() {
        if (Utils.isNetworkAvailable(OrderManagementActivity.context)) {
            ...
            OkHttpUtils
                    ...
                    .addParams("status", Constants.STATUS_UNREFUNdORDER)
    ...
    private void setRecommendProductData() {
        adapter = new CommonAdapter<GetProductOrder.DataBean.productOrderListBean>(
            ...
            protected void convert(ViewHolder holder, GetProductOrder.DataBean.productOrderListBean productOrderListBean, int position) {
                ...
                holder.setText(R.id.tv_type, "待退款");
                holder.setVisible(R.id.item_true_btn, true);
                holder.setText(R.id.item_true_btn, "确认退款");
...
//                        productOrderListBean.getPoNum() + "次浏览");
        ...
        adapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                ...
                intent.putExtra("psId", productOrderListBeanList.get(position).getPsId());
