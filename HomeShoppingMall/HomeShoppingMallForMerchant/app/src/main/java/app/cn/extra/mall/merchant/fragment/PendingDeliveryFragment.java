...
import app.cn.extra.mall.merchant.activity.DeliveryActivity;
...
public class PendingDeliveryFragment extends BaseFragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_pending_delivery, container, false);
    ...
    private void getProductOrder() {
        if (Utils.isNetworkAvailable(OrderManagementActivity.context)) {
            ...
            OkHttpUtils
                    ...
                    .addParams("status", Constants.STATUS_PENDINGDELIVERY)
    ...
    private void setRecommendProductData() {
        adapter = new CommonAdapter<GetProductOrder.DataBean.productOrderListBean>(
            ...
            protected void convert(ViewHolder holder, GetProductOrder.DataBean.productOrderListBean productOrderListBean, int position) {
                ...
                holder.setText(R.id.item_true_btn, "去发货");
...
//去发货
                        Intent intent = new Intent(OrderManagementActivity.context, DeliveryActivity.class);
                        intent.putExtra("poId", productOrderListBean.getPoId());
                        intent.putExtra("intentFlag", "PendingDeliveryFragment");
