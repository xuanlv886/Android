...
import com.netease.nim.uikit.merchant.ScreenMenuFragment;
...
public class P2PMessageActivity extends BaseMessageActivity {
    ...
    private void initRightMenu(String uId) {
...
//        menu.setShadowDrawable(R.drawable.shadow);
                        ...
                        public void onResponse(String response, int id) {
                            ...
                            if (Constants.OK.equals(getUserMemoName.getFlag())) {
                                for (int i = 0; i < getUserMemoName.getData().size(); i++) {
                                    if (getUserMemoName.getData().get(i).getUmnToId().equals(Constants.USERUID)) {
    ...
    protected void changeRemarks() {
        showDialog(Constants.USERUID);
    }

    @Override
    protected void viewUserHistory() {
        menu.showMenu();
    }
    ...
    private void showDialog(String toUid) {
        ...
        tv_live_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //为用户设置备注名
                setUserMemoName(alertDialog, Constants.UID, toUid, memoName);
            }
        });
    }
