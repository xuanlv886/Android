package app.cn.extra.mall.user.utils.widget;
...
public class CustomDatePicker {
    ...
    private void initDialog() {
        if (datePickerDialog == null) {
            datePickerDialog = new Dialog(context, R.style.MyDialogStyleBottom);
            datePickerDialog.setCancelable(true);
            datePickerDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
            datePickerDialog.setContentView(R.layout.custom_date_picker);

            LinearLayout ll_layout = (LinearLayout) datePickerDialog.findViewById(R.id.ll_layout);
            //测量View的宽高
            Utils.measureWidthAndHeight(ll_layout);
            ...
            lp.height = ll_layout.getMeasuredHeight();
            window.setAttributes(lp);
        }
    }

    private void initView() {
        rl_layout = (RelativeLayout) datePickerDialog.findViewById(R.id.rl_layout);
        ...
        rl_layout.setBackgroundColor(context.getResources().getColor(R.color.transparent));
