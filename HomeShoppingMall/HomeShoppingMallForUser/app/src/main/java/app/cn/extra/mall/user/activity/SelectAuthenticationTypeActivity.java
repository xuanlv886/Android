...
//                gotoForgotPasswordActivity();
    ...
    private void gotoForgotPasswordActivity() {
        Intent intent = new Intent();
        intent.setClass(SelectAuthenticationTypeActivity.this, ForgetPasswordActivity.class);
        startActivity(intent);
        finish();
    }
    ...
    private void gotoChangePasswordActivity() {
        Intent intent = new Intent();
        intent.setClass(SelectAuthenticationTypeActivity.this, RevisePasswordActivity.class);
        startActivity(intent);
        finish();
    }
