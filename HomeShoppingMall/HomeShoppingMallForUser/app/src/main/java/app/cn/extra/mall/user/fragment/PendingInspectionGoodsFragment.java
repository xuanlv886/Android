...
import app.cn.extra.mall.user.activity.DemandDetailsActivity;
 ...
 * 待验货
 */
public class PendingInspectionGoodsFragment extends BaseFragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_inspection_goods, container, false);
    ...
    private void getUserRequirement() {
        if (Utils.isNetworkAvailable(MyDemandActivity.context)) {
            ...
            OkHttpUtils
                    ...
                    .addParams("status", Constants.STATUS_DEMAND_INSPECTIONGOODS)
    ...
    private void setRecommendProductData() {
        adapter = new CommonAdapter<GetUserRequirement.DataBean.UserRequirementListBean>(
            ...
            protected void convert(ViewHolder holder, GetUserRequirement.DataBean.UserRequirementListBean userRequirementBean, int position) {
                ...
                holder.setText(R.id.tv_demand_type, "待验货");
                ...
                holder.setText(R.id.tv_complete_time, "取货时间：" + userRequirementBean.getRoGetTime());
                holder.setText(R.id.tv_demand_num, "by " + userRequirementBean.getSName());
        ...
        adapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                Intent intent=new Intent(MyDemandActivity.context, DemandDetailsActivity.class);
                intent.putExtra("urId",userRequirementBeanList.get(position).getUrId());
                intent.putExtra("intentFlag", Constants.STATUS_DEMAND_INSPECTIONGOODS);
