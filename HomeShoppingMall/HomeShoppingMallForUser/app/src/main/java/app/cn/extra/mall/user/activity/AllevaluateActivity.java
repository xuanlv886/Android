...
//                }
     ...
     * @param level
     */
    private void getRoomEvaluatePort(int level) {
        String size = 10 + "";
        if (Utils.isNetworkAvailable(AllevaluateActivity.this)) {
                    ...
                    .execute(new StringCallback() {
                        ...
                        public void onResponse(String response, int id) {
                            ...
                            if ("true".equals(getProductEvaluate.getFlag())) {
                                ...
                                tv_pingjia.setText("酒店评价" + "(" + evaluateNum.getProductEvaluateList().size() + ")");
                                LoadData();
                            } else {
            ...
            showLongToast(AllevaluateActivity.this, Constants.NETWORK_ERROR);
            ...
            OkHttpUtils
                    ...
                    .execute(new StringCallback() {
                        ...
                        public void onResponse(String response, int id) {
                            ...
                            if ("true".equals(getProductEvaluate.getFlag())) {
                                evaluateNum = getProductEvaluate.getData();
                                tv_pingjia.setText("商品评价" + "(" + evaluateNum.getLevelNum() + ")");
                                LoadData();
                            } else {
                                showLongToast(AllevaluateActivity.this, getProductEvaluate.getErrorString());
                                varyViewHelperController.showErrorView();
...
//            Picasso.with(AllevaluateActivity.this).load(data.get(position).getUrl())
//                    .into(holder.iv_item_pingjia_pic);
