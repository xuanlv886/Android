    ...
    private void getProductOrder() {
        if (Utils.isNetworkAvailable(OrderManagementActivity.context)) {
            ...
            OkHttpUtils
                    ...
                    .addParams("status", Constants.STATUS_ALL)
    ...
    private void setRecommendProductData() {
        adapter = new CommonAdapter<GetProductOrder.DataBean.ProductOrderListBean>(
            ...
            protected void convert(ViewHolder holder, GetProductOrder.DataBean.ProductOrderListBean productOrderListBean, int position) {
                ...
                switch ("" + productOrderListBean.getPoStatus()) {
                    ...
                    case Constants.STATUS_PENDINGPAYMENT:
                        ...
                        holder.setText(R.id.item_true_btn, "付款");
                        holder.setVisible(R.id.item_false_btn, true);
                        holder.setText(R.id.item_false_btn, "取消订单");
                        break;
                    case Constants.STATUS_PENDINGDELIVERY:
                        holder.setText(R.id.tv_type, "待发货");
                        holder.setVisible(R.id.item_true_btn, true);
                        holder.setText(R.id.item_true_btn, "申请退款");
                        holder.setVisible(R.id.item_false_btn, false);
                        break;
                    case Constants.STATUS_PENDINGCOLLECTGOODS:
                        holder.setText(R.id.tv_type, "待收货");
                        holder.setVisible(R.id.item_true_btn, true);
                        holder.setText(R.id.item_true_btn, "确认收货");
                        holder.setVisible(R.id.item_false_btn, true);
                        holder.setText(R.id.item_false_btn, "申请退款");
                        break;
                    case Constants.STATUS_PENDINGEVALUATE:
                        holder.setText(R.id.tv_type, "待评价");
                        holder.setVisible(R.id.item_true_btn, true);
                        holder.setText(R.id.item_true_btn, "去评价");
                        holder.setVisible(R.id.item_false_btn, false);
                        break;
