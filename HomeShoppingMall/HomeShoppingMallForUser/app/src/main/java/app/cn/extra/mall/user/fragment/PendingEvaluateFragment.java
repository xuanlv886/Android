...
import app.cn.extra.mall.user.event.PendingEvaluateEvent;
 ...
 * 待评价订单
 */
public class PendingEvaluateFragment extends BaseFragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_pending_evaluate, container, false);
    ...
    private void getProductOrder() {
        if (Utils.isNetworkAvailable(OrderManagementActivity.context)) {
            ...
            OkHttpUtils
                    ...
                    .addParams("status", Constants.STATUS_PENDINGEVALUATE)
