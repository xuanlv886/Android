...
import app.cn.extra.mall.user.event.PendingCollectGoodsEvent;
 ...
 * 待收货订单
 */
public class PendingCollectGoodsFragment extends BaseFragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_pending_collect_goods, container, false);
    ...
    private void getProductOrder() {
        if (Utils.isNetworkAvailable(OrderManagementActivity.context)) {
            ...
            OkHttpUtils
                    ...
                    .addParams("status", Constants.STATUS_PENDINGCOLLECTGOODS)
