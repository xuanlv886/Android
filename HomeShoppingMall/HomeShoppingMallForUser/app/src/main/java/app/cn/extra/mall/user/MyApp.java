...
import app.cn.extra.mall.user.activity.PersonalDataActivity;
import app.cn.extra.mall.user.im.DemoCache;
import app.cn.extra.mall.user.im.NimSDKOptionConfig;
import app.cn.extra.mall.user.im.Preferences;
import app.cn.extra.mall.user.im.location.NimDemoLocationProvider;
...
public class MyApp extends CommonApplication {
    ...
    SessionEventListener listener = new SessionEventListener() {
        ...
        public void onAvatarClicked(Context context, IMMessage message) {
            if ("1".equals(com.netease.nim.uikit.merchant.Constants.sType)) {
