...
import app.cn.extra.mall.user.activity.CompletedDetailsActivity;
import app.cn.extra.mall.user.activity.MyDemandActivity;
import app.cn.extra.mall.user.event.CompletedFragmentEvent;
    ...
    private void getUserRequirement() {
        if (Utils.isNetworkAvailable(MyDemandActivity.context)) {
            ...
            OkHttpUtils
                    ...
                    .addParams("status", Constants.STATUS_DEMAND_COMPLETED)
